    ...
    <div className="h-[100vh] w-screen flex flex-col items-center bg-gray-100">
      ...
      <div className="gap-4 flex">
        <input
          ...
          className="w-[39vw] h-[40px] p-4 border-[1px] bg-gray-100 border-gray-400 rounded-md focus:outline focus:outline-gray-300 focus:outline-offset-2"
      ...
      <div className="flex flex-col gap-2 mt-4 w-[45vw]">
        {tasks.map(({ id, name }) => (
          <div
            key={id}
            className="w-full h-[7vh] p-[7px] bg-white flex items-center text-[.8rem] justify-between rounded-[8px] border-solid border-[2px] border-gray-200"
          >
            <div>
              <p>{name}</p>
