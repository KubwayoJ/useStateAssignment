  ...
  return (
    <div className="w-screen h-[100vh] flex flex-col items-center mt-[40px]">
      ...
      <input
        ...
        className="w-[39vw] h-[40px] p-3 m-4 rounded-[8px] border-solid border-[1px] border-gray-300 focus:outline-none"        
      />
      <button
        onClick={handleSave}
        className="w-[39vw] h-[40px] text-white bg-blue-700 hover:bg-blue-800 rounded-[8px]"
        >
        Save changes
      </button>
    </div>
